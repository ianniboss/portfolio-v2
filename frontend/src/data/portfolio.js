...
export const PROJECTS = [
  ...
  },
  {
    ...
    year: "2025",
    typeEn: "Academic desktop app",
    typeFr: "Projet académique desktop",
    coverHue: 12,
    accent: "amber",
  ...
  },
  {
    ...
    titleFr: "Hub étudiants malaisiens",
    year: "2025 Ongoing",
  ...
  },
  {
    ...
    year: "2025",
    typeEn: "Artificial Intelligence",
    typeFr: "Intelligence Artificielle",
    coverHue: 170,
    accent: "teal",
  ...
  },
  {
    ...
    titleFr: "Générateur de légendes",
    year: "2025",
    typeEn: "Artificial Intelligence",
    typeFr: "Intelligence Artificielle",
    coverHue: 280,
    ...
    descEn:
      "This application generates social media captions in Malay, English, and French. I designed culturally aware prompts and platform-specific formatting using the Gemini API.",
    descFr:
      "Cette application génère des légendes pour les réseaux sociaux en malais, anglais et français. J'ai conçu des prompts adaptés culturellement avec l'API Gemini.",
  ...
  },
  {
    ...
    year: "2025",
    typeEn: "Media utility",
    typeFr: "Utilitaire média",
    coverHue: 36,
    accent: "amber",
  ...
  },
  {
    ...
    titleFr: "Tableau de bord Notion",
    year: "2025",
    typeEn: "Productivity",
    typeFr: "Productivité",
    coverHue: 280,
